...
public class Main {
    public static void main(String[] args) {
        ...
        User U_71200606 = new User("Augusta Clarissa Silvy Pascalin", "augusta.clarissa@ti.ukdw.ac.id", 30000);

        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71200606 = new GoPay(U_71200606);
        ...
        System.out.println("\n========== TOP UP #1 ==========");
        System.out.print("["+E_71200606.getUser().getNama()+"] - ");
        E_71200606.topup(10000);
        ...
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("["+E_71200606.getUser().getNama()+"] - ");
        E_71200606.topup(50000);
        System.out.print("["+E_71200606.getUser().getNama()+"] - ");
        E_71200606.topup(9000);

        System.out.println("\n========== TRANSFER #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.transfer(E_71200606, 2500);
        ...
        System.out.println("\n========== TRANSER #3 ==========");
        System.out.print("["+E_71200606.getUser().getNama()+"] - ");
        E_71200606.transfer(E_71190480, 9500);

        System.out.println("\n========== WITHDRAW #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.withdraw(11000);
        System.out.print("["+E_71200606.getUser().getNama()+"] - ");
        E_71200606.withdraw(1100);
